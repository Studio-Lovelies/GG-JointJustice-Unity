...
namespace Tests.PlayModeTests.Scripts.PauseMenu
{
    public class ViaMouse : PauseMenuTests
    {
        ...
        public IEnumerator PauseMenuCanBeNavigated()
        {
            ...
            {
                yield return SetMouseWorldSpacePosition(GetButtonCenter(button));
        ...
        {
            yield return TestResumeButton(() => ClickAtWorldSpacePosition(GetButtonCenter(GetButton(RESUME_BUTTON_NAME))));
        }
        ...
        {
            yield return TestSettingsButton(() => ClickAtWorldSpacePosition(GetButtonCenter(GetButton(SETTINGS_BUTTON_NAME))));
        }
        ...
        {
            yield return TestMainMenuButton(() => ClickAtWorldSpacePosition(GetButtonCenter(GetButton(MAIN_MENU_BUTTON_NAME))));
        }
        ...
        public IEnumerator ClickingOnBackgroundDoesNotDeselectButton()
        {
            ...
            AssertButtonSelected(button);
            yield return ClickAtWorldSpacePosition(new Vector2(10, 10));
            AssertButtonSelected(button);
        }
